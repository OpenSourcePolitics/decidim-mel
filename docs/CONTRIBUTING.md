  # How to contribute to Métropole Européenne de Lille

We're really glad you're reading this, you might be interested by the code source of the Métropole Européenne de Lille decidim application.
...
* If you're unable to find an open issue addressing the problem, [open a new one on the current repository](https://github.com/OpenSourcePolitics/decidim-mel). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
